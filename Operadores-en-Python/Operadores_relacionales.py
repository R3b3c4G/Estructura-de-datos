...
"""
* NOTA: 
    -Haciendo una comparación entre operadores lógicos y operadores relacionales, los operadores relacionales 
     comparan valores, mientras que los operadores lógicos combinan y evalúan expresiones booleanas para tomar decisiones.  
    -Los operadores relacionales  son símbolos que permiten comparar datos numéricos, de serie de caracteres o lógicos.
"""
